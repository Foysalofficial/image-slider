package com.foysaltech.imageslider.adapters
...
import com.foysaltech.imageslider.R
...
import com.foysaltech.imageslider.transformation.RoundedTransformation
...
class ViewPagerAdapter(
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): View {
        ...
        loader.transform(RoundedTransformation(radius, 0)).placeholder(placeholder)
            .error(errorImage).into(imageView)
